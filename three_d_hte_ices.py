...
for temperature_plug in [295]:
    ...
    file = open('C:/Users/Christian Schuckart/OneDrive/Uni/Master/3 - Masterarbeit/Sand(no_tubes)/sensor_data_highres_pure_sand' + '.csv', 'a')
    ...
    with open('C:/Users/Christian Schuckart/OneDrive/Uni/Master/3 - Masterarbeit/Sand(no_tubes)/temperature_data_highres_pure_sand' + '.json', 'w') as outfile:
