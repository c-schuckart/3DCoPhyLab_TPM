...
for temperature_plug in [295]:
    ...
    file = open('C:/Users/Christian Schuckart/OneDrive/Uni/Master/3 - Masterarbeit/Sand(no_tubes)/test' + '.csv', 'a')
    ...
    with open('C:/Users/Christian Schuckart/OneDrive/Uni/Master/3 - Masterarbeit/Sand(no_tubes)/test' + '.json', 'w') as outfile:
