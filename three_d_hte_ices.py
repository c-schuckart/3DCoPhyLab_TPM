...
from thermal_parameter_functions import lambda_test, lambda_granular, calculate_heat_capacity, lambda_sand, calculate_latent_heat, calculate_density, thermal_functions, lambda_ice_block
from boundary_conditions import energy_input, test, energy_input_data, sample_holder_data, amplitude_lamp, get_energy_input_lamp, calculate_L_chamber_lamp_bd
...
lambdas = [567, 325.5, 162.75]
for lambda_water_ice in lambdas:
    ...
    max_k = const.k
    time_deltas_data_interior, sample_holder_temp = read_temperature_data('D:/Laboratoy_data/temps_ice.txt', '2023-02-22 11:27:02', '2023-02-22 13:00:56', [6], [])
    ...
    for j in tqdm(range(0, min(const.k, max_k, max_k_2))):
        ...
        Lambda = lambda_ice_block(const.n_x, const.n_y, const.n_z, temperature, Dr, dx, dy, dz, lambda_water_ice, const.r_mono, var.VFF_pack, const.sigma, const.e_1, sample_holder, const.lambda_sample_holder) * const.lambda_scaling_factor
        #Lambda = lambda_sand(const.n_x, const.n_y, const.n_z, temperature, Dr, const.lambda_sand, sample_holder, const.lambda_sample_holder)
        ...
        dT_0, EIis_0, E_In, E_Rad, E_Lat_0 = energy_input(const.r_H, const.albedo, const.dt, lamp_power, const.sigma, const.epsilon, temperature, Lambda, Dr, sublimated_mass, resublimated_mass, latent_heat_water, heat_capacity, density, dx, dy, dz, surface, surface_reduced, delta_T)
