...
#density_sand[20][const.n_y//2][const.n_x//2], density_sand[40][const.n_y//2][const.n_x//2], density_sand[70][const.n_y//2][const.n_x//2], density_sand[110][const.n_y//2][const.n_x//2], density_sand[180][const.n_y//2][const.n_x//2] = const.density_copper, const.density_copper, const.density_copper, const.density_copper, const.density_copper
#heat_capacity_sand[20][const.n_y//2][const.n_x//2], heat_capacity_sand[40][const.n_y//2][const.n_x//2], heat_capacity_sand[70][const.n_y//2][const.n_x//2], heat_capacity_sand[110][const.n_y//2][const.n_x//2], heat_capacity_sand[180][const.n_y//2][const.n_x//2] = const.heat_capacity_copper, const.heat_capacity_copper, const.heat_capacity_copper, const.heat_capacity_copper, const.heat_capacity_copper