...
@njit
def boundary_condition_implicit_z_sweep(r_H, albedo, dt, input_energy, sigma, epsilon, epsilon_ambient, temperature, x_sweep_temperature, y_sweep_temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_reduced, sub_alpha, diag, sub_gamma, rhs, S_c, S_p, ambient_temperature):
    for each in surface_reduced:
        S_c_rad = 3 * sigma * (epsilon * temperature[each[2]][each[1]][each[0]]**4 - epsilon_ambient * ambient_temperature**4) * (dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][0] + surface[each[2]][each[1]][each[0]][1]) + dx[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][2] + surface[each[2]][each[1]][each[0]][3]) + dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][4] + surface[each[2]][each[1]][each[0]][5]))
        S_p_rad = -4 * sigma * (epsilon * temperature[each[2]][each[1]][each[0]]**3 - epsilon_ambient * ambient_temperature**3) * (dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][0] + surface[each[2]][each[1]][each[0]][1]) + dx[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][2] + surface[each[2]][each[1]][each[0]][3]) + dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][4] + surface[each[2]][each[1]][each[0]][5]))
        if S_p_rad > 0:
            S_p_rad = 0
            S_c_rad = - sigma * (epsilon * temperature[each[2]][each[1]][each[0]]**4 - epsilon_ambient * ambient_temperature**4) * (dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][0] + surface[each[2]][each[1]][each[0]][1]) + dx[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][2] + surface[each[2]][each[1]][each[0]][3]) + dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][4] + surface[each[2]][each[1]][each[0]][5]))
...
@njit
def boundary_condition_implicit_y_sweep(r_H, albedo, dt, input_energy, sigma, epsilon, epsilon_ambient, temperature, x_sweep_temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_reduced, sub_alpha, diag, sub_gamma, rhs, S_c, S_p, ambient_temperature):
    for each in surface_reduced:
        S_c_rad = 3 * sigma * (epsilon * temperature[each[2]][each[1]][each[0]]**4 - epsilon_ambient * ambient_temperature**4) * (dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][0] + surface[each[2]][each[1]][each[0]][1]) + dx[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][2] + surface[each[2]][each[1]][each[0]][3]) + dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][4] + surface[each[2]][each[1]][each[0]][5]))
        S_p_rad = -4 * sigma * (epsilon * temperature[each[2]][each[1]][each[0]]**3 - epsilon_ambient * ambient_temperature**3) * (dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][0] + surface[each[2]][each[1]][each[0]][1]) + dx[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][2] + surface[each[2]][each[1]][each[0]][3]) + dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][4] + surface[each[2]][each[1]][each[0]][5]))
        if S_p_rad > 0:
...
@njit
def boundary_condition_implicit_x_sweep(r_H, albedo, dt, input_energy, sigma, epsilon, epsilon_ambient, temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_reduced, sub_alpha, diag, sub_gamma, rhs, S_c, S_p, ambient_temperature):
    for each in surface_reduced:
        S_c_rad = 3 * sigma * (epsilon * temperature[each[2]][each[1]][each[0]]**4 - epsilon_ambient * ambient_temperature**4) * (dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][0] + surface[each[2]][each[1]][each[0]][1]) + dx[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][2] + surface[each[2]][each[1]][each[0]][3]) + dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][4] + surface[each[2]][each[1]][each[0]][5]))
        S_p_rad = -4 * sigma * (epsilon * temperature[each[2]][each[1]][each[0]]**3 - epsilon_ambient * ambient_temperature**3) * (dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][0] + surface[each[2]][each[1]][each[0]][1]) + dx[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][2] + surface[each[2]][each[1]][each[0]][3]) + dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] * (surface[each[2]][each[1]][each[0]][4] + surface[each[2]][each[1]][each[0]][5]))
        if S_p_rad > 0:
...
@njit
def hte_implicit_DGADI(n_x, n_y, n_z, surface_reduced, r_H, albedo, dt, input_energy, sigma, epsilon, epsilon_ambient, temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, S_c, S_p, sample_holder, ambient_temperature):
        ...
        for j in range(1, n_y-1):
            ...
            for each in surface_reduced:
                if each[2] == i and each[1] == j:
                    ...
                    counter += 1
            sub_alpha, diag, sub_gamma, rhs = boundary_condition_implicit_x_sweep(r_H, albedo, dt, input_energy, sigma, epsilon, epsilon_ambient, temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_elements_in_line[0:counter], sub_alpha, diag, sub_gamma, rhs, S_c, S_p, ambient_temperature)
        ...
        for k in range(1, n_x-1):
            ...
            for each in surface_reduced:
                if each[2] == i and each[0] == k:
                    surface_elements_in_line[counter] = np.array([each[0], each[1], each[2]], dtype=np.float64)
                    counter += 1
            sub_alpha, diag, sub_gamma, rhs = boundary_condition_implicit_y_sweep(r_H, albedo, dt, input_energy, sigma, epsilon, epsilon_ambient, temperature, x_sweep_temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_elements_in_line[0:counter], sub_alpha, diag, sub_gamma, rhs, S_c, S_p, ambient_temperature)
        ...
        for k in range(1, n_x-1):
            ...
            for each in surface_reduced:
                if each[1] == j and each[0] == k:
                    surface_elements_in_line[counter] = np.array([each[0], each[1], each[2]], dtype=np.float64)
                    counter += 1
            sub_alpha, diag, sub_gamma, rhs = boundary_condition_implicit_z_sweep(r_H, albedo, dt, input_energy, sigma, epsilon, epsilon_ambient, temperature, x_sweep_temperature, y_sweep_temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_elements_in_line[0:counter], sub_alpha, diag, sub_gamma, rhs, S_c, S_p, ambient_temperature)
...
@njit
def boundary_condition_implicit_z_sweep_periodic(r_H, albedo, dt, input_energy, sigma, epsilon, temperature, x_sweep_temperature, y_sweep_temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_reduced, sub_alpha, diag, sub_gamma, rhs, S_c, S_p, n_x, n_y):
    for each in surface_reduced:
        x_neg_periodic, x_pos_periodic, y_neg_periodic, y_pos_periodic = 0, 0, 0, 0
        if each[0] == 1:
           x_neg_periodic = 1
        ...
        sub_alpha[each[2]] = - a_t
        sub_gamma[each[2]] = - a_b
        rhs[each[2]] = a_t * temperature[each[2] + 1][each[1]][each[0]] + a_b * temperature[each[2] - 1][each[1]][each[0]] + a_n * ((y_sweep_temperature[each[2]][each[1] + 1][each[0]] + temperature[each[2]][each[1] + 1][each[0]])/2 * (1 - y_pos_periodic) + (y_sweep_temperature[each[2]][1][each[0]] + temperature[each[2]][1][each[0]])/2 * y_pos_periodic)+ a_s * ((y_sweep_temperature[each[2]][each[1] - 1][each[0]] + temperature[each[2]][each[1] - 1][each[0]])/2 * (1 - y_neg_periodic) + (y_sweep_temperature[each[2]][n_y-2][each[0]] + temperature[each[2]][n_y-2][each[0]])/2 * y_neg_periodic) + a_e * ((x_sweep_temperature[each[2]][each[1]][each[0] + 1] + temperature[each[2]][each[1]][each[0] + 1])/2 * (1 - x_pos_periodic) + (x_sweep_temperature[each[2]][each[1]][1] + temperature[each[2]][each[1]][1])/2 * x_pos_periodic) + a_w * ((x_sweep_temperature[each[2]][each[1]][each[0] - 1] + temperature[each[2]][each[1]][each[0] - 1])/2 * (1 - x_neg_periodic) + (x_sweep_temperature[each[2]][each[1]][n_x-2] + temperature[each[2]][each[1]][n_x-2])/2 * x_neg_periodic) + Q + S_c[each[2]][each[1]][each[0]] * dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] + S_c_rad + (density[each[2]][each[1]][each[0]] * heat_capacity[each[2]][each[1]][each[0]] * dx[each[2]][each[1]][each[0]] * dy[each[2]][each[1]][each[0]] * dz[each[2]][each[1]][each[0]] / dt - a_t - a_b) * temperature[each[2]][each[1]][each[0]] - (a_n + a_s) * (y_sweep_temperature[each[2]][each[1]][each[0]] + temperature[each[2]][each[1]][each[0]])/2 - (a_w + a_e) * (x_sweep_temperature[each[2]][each[1]][each[0]] + temperature[each[2]][each[1]][each[0]])/2
        '''if each[2] == 1:
...
def set_matrices_rhs_y_sweep_periodic(n_y, i, k, rhs, temperature, x_sweep_temperature, surface, sample_holder, dx, dy, dz, Dr, Lambda, density, heat_capacity, dt, S_c, n_x):
    ...
    for j in range(0, n_y):
        ...
        if temperature[i][j][k] > 0 and np.sum(surface[i][j][k]) == 0 and rhs[j] == 0:
            ...
            a_e = Lambda[i][j][k][4] * dy[i][j][k] * dz[i][j][k] / Dr[i][j][k][4]
            a_w = Lambda[i][j][k][5] * dy[i][j][k] * dz[i][j][k] / Dr[i][j][k][5]
            rhs[j] = a_t * temperature[i+1][j][k] + a_b * temperature[i-1][j][k] + a_n * (temperature[i][j+1][k] * (1 - y_pos_periodic) + temperature[i][1][k] * y_pos_periodic) + a_s * (temperature[i][j-1][k] * (1 - y_neg_periodic) + temperature[i][n_y-2][k] * y_neg_periodic) + a_e * ((x_sweep_temperature[i][j][k+1] + temperature[i][j][k+1])/2 * (1 - x_pos_periodic) + (x_sweep_temperature[i][j][1] + temperature[i][j][1])/2 * x_pos_periodic ) + a_w * ((x_sweep_temperature[i][j][k-1] + temperature[i][j][k-1])/2 * (1 - x_neg_periodic) + (x_sweep_temperature[i][j][n_x-2] + temperature[i][j][n_x-2])/2 * x_neg_periodic) + S_c[i][j][k] * dx[i][j][k] * dy[i][j][k] * dz[i][j][k] + (density[i][j][k] * heat_capacity[i][j][k] * dx[i][j][k] * dy[i][j][k] * dz[i][j][k] / dt - a_t - a_b - a_n - a_s) * temperature[i][j][k] - (a_w + a_e) * (x_sweep_temperature[i][j][k] + temperature[i][j][k])/2
        elif sample_holder[i][j][k] != 0:
            rhs[j] = density[i][j][k] * heat_capacity[i][j][k] * dx[i][j][k] * dy[i][j][k] * dz[i][j][k] / dt * temperature[i][j][k]
        elif temperature[i][j][k] == 0:
            rhs[j] = 0
...
def set_matrices_rhs_x_sweep_periodic(n_x, i, j, rhs, temperature, surface, sample_holder, dx, dy, dz, Dr, Lambda, density, heat_capacity, dt, S_c, n_y):
    ...
    for k in range(0, n_x):
        ...
        if temperature[i][j][k] > 0 and np.sum(surface[i][j][k]) == 0 and rhs[k] == 0:
            ...
            a_e = 1 / 2 * Lambda[i][j][k][4] * dy[i][j][k] * dz[i][j][k] / Dr[i][j][k][4]
            a_w = 1 / 2 * Lambda[i][j][k][5] * dy[i][j][k] * dz[i][j][k] / Dr[i][j][k][5]
            rhs[k] = a_t * temperature[i+1][j][k] + a_b * temperature[i-1][j][k] + a_n * (temperature[i][j+1][k] * (1 - y_pos_periodic) + temperature[i][1][k] * y_pos_periodic) + a_s * (temperature[i][j-1][k] * (1 - y_neg_periodic) + temperature[i][n_y-2][k] * y_neg_periodic) + a_e * (temperature[i][j][k+1] * (1 - x_pos_periodic) + temperature[i][j][1] * x_pos_periodic) + a_w * (temperature[i][j][k-1] * (1 - x_neg_periodic) + temperature[i][j][n_x-2] * x_neg_periodic) + S_c[i][j][k] * dx[i][j][k] * dy[i][j][k] * dz[i][j][k] + (density[i][j][k] * heat_capacity[i][j][k] * dx[i][j][k] * dy[i][j][k] * dz[i][j][k] / dt - a_t - a_b - a_n - a_s - a_e - a_w) * temperature[i][j][k]
        elif sample_holder[i][j][k] != 0:
            rhs[k] = density[i][j][k] * heat_capacity[i][j][k] * dx[i][j][k] * dy[i][j][k] * dz[i][j][k] / dt * temperature[i][j][k]
        elif temperature[i][j][k] == 0:
            rhs[k] = 0
...
@njit
def hte_implicit_DGADI_periodic(n_x, n_y, n_z, surface_reduced, r_H, albedo, dt, input_energy, sigma, epsilon, temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, S_c, S_p, sample_holder):
    next_step_temperature = np.zeros((n_z, n_y, n_x), dtype=np.float64)
    x_sweep_temperature = np.zeros((n_z, n_y, n_x), dtype=np.float64)
    y_sweep_temperature = np.zeros((n_z, n_y, n_x), dtype=np.float64)
    for i in range(1, n_z-1):
        for j in range(1, n_y-1):
            ...
            for each in surface_reduced:
                if each[2] == i and each[1] == j:
                    surface_elements_in_line[counter] = np.array([each[0], each[1], each[2]], dtype=np.float64)
                    counter += 1
            sub_alpha, diag, sub_gamma, rhs = boundary_condition_implicit_x_sweep_periodic(r_H, albedo, dt, input_energy, sigma, epsilon, temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_elements_in_line[0:counter], sub_alpha, diag, sub_gamma, rhs, S_c, S_p, n_x, n_y)
            sub_alpha, diag, sub_gamma = set_matrices_lhs_x_sweep(n_x, i, j, sub_alpha, diag, sub_gamma, Lambda, dx, dy, dz, Dr, density, heat_capacity, dt, S_p, temperature, surface, sample_holder)
            rhs = set_matrices_rhs_x_sweep_periodic(n_x, i, j, rhs, temperature, surface, sample_holder, dx, dy, dz, Dr, Lambda, density, heat_capacity, dt, S_c, n_y)
            x_sweep_temperature[i, j, 1:n_x-1] = periodic_tridiagonal_matrix_solver(n_x-2, diag[1:n_x-1], sub_gamma[1:n_x-1], sub_alpha[1:n_x-1], rhs[1:n_x-1])
    for i in range(1, n_z-1):
        for k in range(1, n_x-1):
            sub_alpha = np.zeros(n_y, dtype=np.float64)
            diag = np.zeros(n_y, dtype=np.float64)
            ...
            for each in surface_reduced:
                if each[2] == i and each[0] == k:
                    surface_elements_in_line[counter] = np.array([each[0], each[1], each[2]], dtype=np.float64)
                    counter += 1
            sub_alpha, diag, sub_gamma, rhs = boundary_condition_implicit_y_sweep_periodic(r_H, albedo, dt, input_energy, sigma, epsilon, temperature, x_sweep_temperature, Lambda, Dr, heat_capacity, density, dx, dy, dz, surface, surface_elements_in_line[0:counter], sub_alpha, diag, sub_gamma, rhs, S_c, S_p, n_x, n_y)
            sub_alpha, diag, sub_gamma = set_matrices_lhs_y_sweep(n_y, i, k, sub_alpha, diag, sub_gamma, Lambda, dx, dy, dz, Dr, density, heat_capacity, dt, S_p, temperature, surface, sample_holder)
            rhs = set_matrices_rhs_y_sweep_periodic(n_y, i, k, rhs, temperature, x_sweep_temperature, surface, sample_holder, dx, dy, dz, Dr, Lambda, density, heat_capacity, dt, S_c, n_x)
    ...
    for j in range(1, n_y-1):
        for k in range(1, n_x-1):
            ...
            '''if j < 3:
                ...
                print(sub_alpha)
                print(rhs)'''
            next_step_temperature[1:n_z-1, j, k] = tridiagonal_matrix_solver(n_z-2, diag[1:n_z-1], sub_gamma[1:n_z-1], sub_alpha[1:n_z-1], rhs[1:n_z-1])
    return next_step_temperature