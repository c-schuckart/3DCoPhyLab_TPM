...
fig.colorbar(cm.ScalarMappable(norm=norm, cmap=cmap), cax=ax2, label='Temperature (K)', shrink=1, aspect=1, fraction=0.05)
#fig.colorbar(vx)
...
plt.savefig('C:/Users/Christian/OneDrive/Uni/Master/3 - Masterarbeit/Presentation_plots/13_period_cam.png', dpi=600)
plt.show()